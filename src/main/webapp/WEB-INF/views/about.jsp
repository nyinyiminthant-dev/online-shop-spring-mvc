...
<section class="container mt-5">
    <h2>About Us</h2>
    <p>
        We are an online store dedicated to providing a seamless shopping experience. <br> From electronics to clothing,
         we offer a wide variety of products to meet your needs.  <br> Our goal is to deliver high-quality items and exceptional customer service.
    </p>
    <p>
    <br>
        <i class="bi bi-check-circle"></i> Quality Assurance<br><br>
        <i class="bi bi-check-circle"></i> Fast and Reliable Shipping<br>
        <br>
        <i class="bi bi-check-circle"></i> Excellent Customer Support<br><br>
    </p>
    
  <img alt="" src="${pageContext.request.contextPath}/upload/model3.png" class="bg-img">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-pzjw8f+ua7Kw1TIq0V9Fok4G28h15VTh9sojflM9+cbS5KFS5pMeTPU2XVlf8pgy" crossorigin="anonymous"></script>
</body>
</html>
